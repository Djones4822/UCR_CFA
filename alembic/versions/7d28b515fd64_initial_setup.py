...
def upgrade():
    ...
    op.create_table('city_county_relate',
                    sa.Column('city_id', sa.Integer,
                              sa.ForeignKey('cities.city_id')),
                    sa.Column('county_id', sa.Integer,
                              sa.ForeignKey('counties.county_id')),
    ...
    op.create_table('locations',
                    ...
                    sa.Column('city_id', sa.Integer,
                              sa.ForeignKey('cities.city_id'), nullable=False),
                    sa.Column('county_id', sa.Integer,
                              sa.ForeignKey('counties.county_id'),
                              nullable=False),
                    sa.Column('zip_code', sa.Numeric(5, 0),
                              sa.ForeignKey('zip_codes.zip_code'),
                              nullable=True),
    ...
    op.create_table('agency_fuzzy_names',
                    sa.Column('agency_id', sa.Integer,
                              sa.ForeignKey('agencies.agency_id')),
    ...
    op.create_table('agency_type_relate',
                    sa.Column('agency_id', sa.Integer,
                              sa.ForeignKey('agencies.agency_id')),
                    sa.Column('agency_type_id', sa.Integer,
                              sa.ForeignKey('agency_types.agency_type_id')),
    ...
    op.create_table('crime_types',
                    ...
                    sa.Column('description', sa.String(300), nullable=False),
                    sa.Column('parent_crime_type_id', sa.Integer,
                              sa.ForeignKey('crime_types.crime_type_id'),
                              nullable=True))
    op.create_table('crime_type_relate',
                    sa.Column('crime_id', sa.Integer,
                              sa.ForeignKey('crimes.crime_id')),
